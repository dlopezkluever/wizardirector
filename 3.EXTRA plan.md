...
- We need to allow for the name to also be allowed to be replaced if desired. Theres a couple options we can implement. 1. (project name) ('Staring'/'' Global Name)
