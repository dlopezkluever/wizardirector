...
### 10.1 — Seemingly no Influence from Master Assets in Frame Generation (Inheritance Failure)
...
Allow a scale/level of influence for how much the visual style capsule affects generations. Currently it's all-or-nothing and can dominate over master reference images in stage 8. 
