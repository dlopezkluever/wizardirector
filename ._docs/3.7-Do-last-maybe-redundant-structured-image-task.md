...
> Current prompts are too vague, — likely not optimal for frame/video generation. Need robust, structured, deterministic prompts that leverage all work done in previous stages. Set format optimized per provider (one for Sora, one for Veo3).
