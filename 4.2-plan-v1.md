...
**Rationale:** Scriptwriting is notorious for minor typos (e.g., "JONATHAN" vs "JONATHON"). If the system is too rigid, users will constantly see "New Character Detected" warnings for assets they've already defined in Stage 5. The 0.85 threshold balances accuracy with tolerance for common variations.
