...
#### **Image Generation**
- [ ] Generate character image → verify 2:3 portrait (512x768)
- [ ] Generate location image → verify 16:9 cinematic (1024x576)
- [ ] Generate prop image → verify 1:1 square (512x512)
- [ ] Attempt generation without visual style → should fail
- [ ] Verify style context injected in all generations

#### **Project Assets Routes**
- [ ] Test extraction without style selected → should fail
- [ ] Test extraction without Stage 4 complete → should fail
- [ ] Test merge operation with two assets
- [ ] Test delete locked asset → should fail
- [ ] Test update locked asset → should fail
- [ ] Test lock asset without image → should fail
- [ ] Test lock-all with unlocked assets → should fail
- [ ] Test promotion without image → should fail

### Frontend Testing

#### **Visual Style Lock**
- [ ] Attempt extraction without style → button disabled
- [ ] Select style → extraction button enables
...
- [ ] Generate image → polls until completion
- [ ] Batch generate creates all images sequentially
- [ ] Lock asset → updates UI immediately
- [ ] Delete asset → removes from list
- [ ] Promote asset → success message appears
