...
│                 │    │                  │    │                 │
│ • style_capsule │◄──►│ • styleCapsule  │◄──►│ • Library Page  │
...
### **⚠️ Known Issues**
- Storage RLS policies need manual setup via Supabase dashboard
- Image upload will fail until storage policies are configured
...
1. **Test API Endpoints** with Postman/DevTools
