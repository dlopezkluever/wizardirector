<!-- c083f07d-b632-4def-8f29-e823c53c31c1 acd0c23c-8576-4143-9b7c-3f5c957f3fbb -->
...
- [ ] Create migration file with global_assets and project_assets tables
- [ ] Implement assets router with CRUD endpoints
- [ ] Register assets router in server.ts
- [ ] Create TypeScript types for assets
- [ ] Implement assetService for API communication
- [ ] Build main AssetLibrary page with tabs and layout
- [ ] Create AssetCard component for display
- [ ] Build create/edit dialog with form validation
- [ ] Implement gallery grid with responsive layout
- [ ] Create delete confirmation with dependency checking
- [ ] Add search and filter functionality
- [ ] Update Index.tsx routing to render AssetLibrary